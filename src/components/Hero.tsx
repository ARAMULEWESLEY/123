  ...
  return (
    <>
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-muted/30 to-background">
        {/* Cart button fixed to top right */}
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 py-16 sm:py-20 max-w-4xl mx-auto animate-fade-in">
        <div className="mb-6 sm:mb-8 animate-float">
          <img 
            src={steadfastLogo} 
            alt="Steadfast Enterprises - Creating Value" 
            className="w-64 sm:w-80 md:w-96 lg:w-[28rem] mx-auto drop-shadow-2xl"
          />
        </div>
        
        <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white font-extrabold mb-8 sm:mb-12 max-w-3xl mx-auto leading-tight px-4 drop-shadow-lg">
          Welcome to Steadfast Enterprises Limited family, feel free to join us
        </p>
